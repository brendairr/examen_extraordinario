...
@step(u'Entonces puedo eliminar, editar o quitar el estatus de rentada a una pelicula')
def entonces_puedo_eliminar_editar_o_quitar_el_estatus_de_rentada_a_una_pelicula(step):
	pass